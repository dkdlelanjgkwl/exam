...
function recursiveBinarySearch(array, target, startIndex = 0, endIndex = array.length - 1) {
  ...
  if (target > array[halfIndex] && endIndex - startIndex > 0) {
    ...
    indexOfTarget = recursiveBinarySearch(array, target, startIndex, halfIndex - 1);
  } else if (target === array[halfIndex]) {
    indexOfTarget = halfIndex;
  } else {
    indexOfTarget = -1;
...
console.log(recursiveBinarySearch(arr123, 5023));
console.log(recursiveBinarySearch(arr123, 6000));
